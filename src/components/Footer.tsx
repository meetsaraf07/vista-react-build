const Footer = () => {
  ...
  const getHref = (category: string, link: string) => {
    if (category === "Services" || category === "Use Cases") return "#services";
  ...
  return (
    <footer id="footer" className="py-12">
      <div className="max-w-7xl mx-auto px-6">
        <div className="bg-foreground text-background rounded-t-3xl shadow-[var(--shadow-elegant)] px-6 md:px-12 py-12">
